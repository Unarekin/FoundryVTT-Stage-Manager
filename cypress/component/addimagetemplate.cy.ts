describe("AddImageDialog template", () => {
  it("has proper structure", () => {
    cy.fixture("addimagetemplate-context")
      ...
      .then((context: any) => cy.mount("./src/templates/dialogs/add-image.hbs", { context, isDialog: true }))
      ...
      .get(`[data-cy-element="filepicker"]`).then((elem: any) => cy.wrap(elem, { log: false })
        ...
        .wrap(elem, { log: false })
        .get(".notes").contains("STAGEMANAGER.DIALOGS.ADDIMAGE.FILEPICKER.HINT")
      ...
      .then((elem: any) => {
        return cy.wrap(elem, { log: false })
          ...
          .wrap(elem, { log: false })
          .get(".notes").contains("STAGEMANAGER.DIALOGS.ADDIMAGE.NAME.HINT")
